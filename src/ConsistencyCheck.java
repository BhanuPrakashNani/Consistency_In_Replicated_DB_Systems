...
public class ConsistencyCheck {
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		while(true) {
			...
			if(arrOfStr[0].equals("P1:")&&arrOfStr[2].equals("Write") && arrOfStr[1].equals("Exit") && arrOfStr[4].equals("6")){
				boolean found = false;
				System.out.println(arrOfStr);
					qwrites.add(Integer.parseInt(arrOfStr[7]));
		...
		System.out.println("Queue: qwrites "+ qwrites);
