...
//         	      String insert = "INSERT INTO samplermi(id, name, branch, percentage, email) values("+list.get(list.size()-1).getId()+",'"+list.get(list.size()-1).getName()+"','"+ list.get(list.size()-1).getBranch()+"',"+list.get(list.size()-1).getPercent()+",'"+ list.get(list.size()-1).getEmail()+ "')";
        	 ...
        	 Thread.sleep(2000);
	         System.out.println("HElllo man DBSTATUS2 "+stub_s3.dbstatus(0)+" "+stub_s3.dbstatus(1)+ " is Write "+stub_s3.isWrite());
	 
        	 if(stub_s3.dbstatus(3) == 1) {
       		  System.out.println("???ASSAS??AS?SA?A");
...
//        	      String insert = "INSERT INTO samplermi(id, name, branch, percentage, email) values("+list.get(list.size()-1).getId()+",'"+list.get(list.size()-1).getName()+"','"+ list.get(list.size()-1).getBranch()+"',"+list.get(list.size()-1).getPercent()+",'"+ list.get(list.size()-1).getEmail()+ "')";
        	 ...
        	 if(stub_self.dbstatus() == 0 && stub_s1.dbstatus() == 0 && stub_s1.getStatus() == 0 && stub_s3.dbstatus() == 0 && stub_s3.getStatus() == 0) {
        		 stub_self.setStatus();
